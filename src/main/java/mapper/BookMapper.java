...
public class BookMapper {
    ...
    public static Book convertBookDTOToBook(BookDTO bookDTO){
        return new BookBuilder().setTitle(bookDTO.getTitle()).setAuthor(bookDTO.getAuthor()).setPublishedDate(LocalDate.of(2010, 1, 1)).setPrice(bookDTO.getPrice()).setStock(bookDTO.getStock()).build(); //d ce setam asa data?
    }

    public static List<BookDTO> convertBookDTOToListToBookDTOList(List<Book> books) {
